...
export const getParamsByUrl = async (url, filename = 'product' + Math.random()) => {
  ...
  // fs.writeFile(`./src/crawler/data/${filename}.json`, JSON.stringify(result), {}, (err) => {
  //   if (err) {
  //     return console.log('写入失败', err.message, err);
  //   }
  //   console.log('写入成功');
  // });
...
// getParamsByUrl('https://detail.zol.com.cn/1363/1362658/param.shtml', 'oppo_find_x3_pro');
